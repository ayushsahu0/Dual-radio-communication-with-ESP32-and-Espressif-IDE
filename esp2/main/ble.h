/* A BLE Server */
/* find GATT_WRITE_EVT to do any changes in receive part */
#ifndef BLE_H
#define BLE_H
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_WRITE_EVT: {
        ...
        // Extract 1st and 3rd characters (indices 0 and 2 respectively)
    ...
    case ESP_GATTS_CONF_EVT:
        ...
        esp_ble_gatts_close(gatts_if, gl_profile_tab[PROFILE_A_APP_ID].conn_id);
